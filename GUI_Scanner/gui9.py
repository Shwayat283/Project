...
class ScannerApp(tk.Tk):
    ...
    def _open_scanner(self, vuln_type):
        ...
        # تطبيق الحالة والحجم على النافذة الفرعية
    ...
    def _on_child_close(self, window):
        # استعادة حالة وحجم النافذة الرئيسية
...
class GenericWindow(tk.Toplevel):
    ...
    def _on_back(self):
        # استخدم دالة اغلاق النافذة الرئيسية لاستعادة الحجم والحالة
